...
namespace University.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["StudentID"] = new SelectList(_context.Set<Student>(), "StudentID", "FirstMidName");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("EnrollmentID,CourseID,StudentID,Grade")] Enrollment enrollment)
        {
            ...
            ViewData["StudentID"] = new SelectList(_context.Set<Student>(), "StudentID", "FirstMidName", enrollment.StudentID);
            return View(enrollment);
        }
